...
Phases from [hbr] the process to generate better critical thinking skills
...
The first model seems to be a good indicator. There was a [study] that shows that it does expand across cultures. It also replicable according to a [dutch] article.
