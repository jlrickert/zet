# Example of a vm with out a garbage collect

Some on one acorn1010's stream posted code for a vm without a garbage
collector. I have a copy of the [code] here.
...
[code]: https://git.sr.ht/~rabbits/uxn/tree/main/item/src/uxn.c
